...
class tax(TransactionBase):
	...
	def compute_taxable_earnings_for_year(self):
		...
		print ("previous_taxable_earnings  1 ",self.previous_taxable_earnings)
		print ("current_structured_taxable_earnings  1 ",self.current_structured_taxable_earnings)
		print ("future_structured_taxable_earnings  1 ",self.future_structured_taxable_earnings)
		print ("current_additional_earnings  1 ",self.current_additional_earnings)
		print ("other_incomes  1 ",self.other_incomes)
		print ("unclaimed_taxable_benefits  1 ",self.unclaimed_taxable_benefits)
		print ("total_exemption_amount  1 ",self.total_exemption_amount)
		...
		print ("total_taxable_earnings  1 ",self.total_taxable_earnings)
	...
	def compute_income_tax_breakup(self):
		...
		if hasattr(self, "total_structured_tax_amount") and hasattr(self, "current_structured_tax_amount"):
			...
			print("adding  ------------------", self.get("full_tax_on_additional_earnings", 0))
			print("minus --------------------", self.income_tax_deducted_till_date)
			print("total_structured_tax_amount --------------------", self.total_structured_tax_amount)
			print("current_structured_tax_amount --------------------", self.current_structured_tax_amount)
	...
	def calculate_variable_tax(self, tax_component):
		...
		if self.current_additional_earnings_with_full_tax:
			# print("self.current_additional_earnings_with_full_tax",self.current_additional_earnings_with_full_tax)
